...
import com.aloha.login.security.prop.JwtProps;
...
public class JwtProvider {
    ...
    public String createToken(String id, String username, List<String> roles) {
        ...
        String jwt = Jwts.builder()
                         ...
                         .and()
                         .expiration( new Date( System.currentTimeMillis() + exp ) )    // 토큰 만료시간 설정
    ...
    public UsernamePasswordAuthenticationToken getAuthenticationToken(String authorization) {
        ...
        try {
            ...
            // new UsernamePasswordAuthenticationToken( 사용자 정보 객체, 비밀번호, 권한 목록 )
